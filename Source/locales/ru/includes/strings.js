...
// Options page
	...
	sWhatsPar3: "<b>Внимание!</b> Расширение перехватывает ВСЕ клавиши, включая стандартные, поэтому будьте осторожны и не переопределяйте такие комбинации, как Ctrl-Z, Ctrl-X, Ctrl-C, Ctrl-V, Ctrl-A. Вместе с тем, это происходит только если фокус ввода находится в поле набора текста; в других случаях клавиши работают как обычно.",
